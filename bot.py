...
Basic_Q = ("How do I pay on Daraz??","How do I pay on Daraz","How do I pay on Daraz?","How do I pay on Daraz.")
Basic_Ans = "Paying on Daraz is super easy. Please refer to this video:We have the following payment methods through which you can make a payment:• Cash On Delivery• Credit/Debit Card• eSewa"
